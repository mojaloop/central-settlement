...
const Facade = require('../../src/models/transferParticipantStateChange/facade')
  ...
  const sandbox = {
    ...
    log: function (message) {
     ...
     getTransfer (transferId) {
      //    const transferObject = (async () => await Facade.getTransactionRequest(transferId))()
      const transferObject = await Facade.getTransactionRequest(transferId)
