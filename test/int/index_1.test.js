...
const TransferSettlement =  require('../../src/handlers/transferSettlement/handler')
const process2spy = sandbox.spy(TransferSettlement,'processTransferSettlement')
...
afterAll (async () => {
  // TODO https://stackoverflow.com/questions/47997652/jest-beforeall-share-between-multiple-test-files
